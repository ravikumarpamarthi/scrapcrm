...
angular.module('scrapQcrmApp')
    .controller('UnAssginedCtrl', function($scope, $moment, $uibModal, $global, dashboard, SellNow, ngTableParams, $log, $stateParams,agentAppointments) {
        $scope.date = {
        ...
        $scope.transactionChange = function() {
            ...
            $scope.vm.params.status = 'REQUEST_INITIATED';
             $scope.unassigned($scope.vm.params);
        };
