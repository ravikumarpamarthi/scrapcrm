...
/**
 * @ngdoc function
 * @name scrapQcrmApp.controller:DeclinedCtrl 
 * @description
 * # AboutCtrl
 * Controller of the scrapQcrmApp
 */
angular.module('scrapQcrmApp')
    .controller('DeclinedCtrl', function($scope, $moment, $uibModal, $global, dashboard, SellNow, ngTableParams, $log, $stateParams, agentAppointments) {
        $scope.date = {
        ...
        $scope.transactionChange = function() {
            ...
            $scope.vm.params.status = 'DECLINED_BY_AGENT';
            $scope.declined($scope.vm.params);
        };
